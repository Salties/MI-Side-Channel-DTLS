...
int main(int argc, char **argv)
{
    ...
    for (n = 0; n < sizeof(data) / sizeof(struct test_vector); ++n)
	  ...
	  len =
	      dtls_ccm_encrypt_message(&ctx, data[n].M, data[n].L, data[n].nonce,
				       data[n].msg + data[n].la, data[n].lm - data[n].la, data[n].msg, data[n].la);
	  ...
	  len =
	      dtls_ccm_decrypt_message(&ctx, data[n].M, data[n].L, data[n].nonce,
				       data[n].msg + data[n].la, len - data[n].la, data[n].msg, data[n].la);
