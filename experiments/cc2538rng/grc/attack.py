...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.defaultfreq = defaultfreq = 2475e6
        self.signaloffset = signaloffset = 1
        self.signalfreq = signalfreq = defaultfreq
        self.signalamp = signalamp = 0
        ...
        self.osmosdr_sink_0.set_center_freq(signalfreq, 0)
    ...
    def get_defaultfreq(self):
        return self.defaultfreq
    ...
    def set_signaloffset(self, signaloffset):
        self.signaloffset = signaloffset
        self.analog_sig_source_x_0.set_offset(self.signaloffset)

    def get_signalfreq(self):
        return self.signalfreq

    def set_signalfreq(self, signalfreq):
        self.signalfreq = signalfreq
        self.osmosdr_sink_0.set_center_freq(self.signalfreq, 0)

    def get_signalamp(self):
        return self.signalamp

    def set_signalamp(self, signalamp):
        self.signalamp = signalamp
        self.analog_sig_source_x_0.set_amplitude(self.signalamp)
