...
In fact as an implementation optimisation of this method, one can directly construct the Leakage Channel by iterating through each column of the Forward Channel without storing the intermediate tables, as described in \Cref{Alg: FC2LC}.
