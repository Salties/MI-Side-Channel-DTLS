...
Our simulation shows that even though the exact content of these messages are hidden under the encryption provided by noncoresec, some of them are still distinguishable simply by packet size and type of MAC destination, as summarised in \Cref{ICMPPacketFeature}:
