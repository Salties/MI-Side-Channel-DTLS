...
\begin{itemize}
	\item DTLS is built on datagrams instead of TCP like TLS. In case of a 6LoWPAN network, this is effectively UDP. As a result DTLS implemented a simple reliable transmission mechanism during handshake to reliably exchange the cryptographic parameters.
...
\begin{description}[style=nextline]
	...
	CHANGE\_CIPHER\_SPEC. This value is used as an index of which set of cryptographic parameters to be used, such as algorithms, keys or nonces.
	\item[\textbf{Sequence Number}]
