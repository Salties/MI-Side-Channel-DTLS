...
\Cref{Fig: An Example of CoAP} is a screen shot of accessing a CoAP server running on a CC2538 node through the Copper plugin of Firefox. CoAP has the following features:
\begin{itemize}
...
\end{itemize}
%CoAP as TCP
In addition to the definition of general application data interface, CoAP also provides a lightweight reliable transmission mechanism; therefore some context consider CoAP as a Transport Layer protocol that replaces TCP.
