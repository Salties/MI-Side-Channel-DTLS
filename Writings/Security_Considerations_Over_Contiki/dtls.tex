...
Since application data are encrypted using AES-128 CCM, the size of application data is not hidden and is visible in the header, as highlighted in \Cref{Fig: Size of application data in DTLS}.
