...
So \Cref{Eq: CC2538tP} is our estimation of the protocol suite processing time for a CC2538 Sensor Node using Contiki release-3.0 with tinydtls, upon observing a Request of length $|Req|$ with Response of length $|Res|$.
...
In conclusion, our estimation of the application execution time $t_A$:
\begin{itemize}
...
We give further detailed analysis of the error in \Cref{ta error}.
...
We show the overall signed approximation error among all $t_A$ we tested in \Cref{Fig: Overall approximation error}.
