...
To further investigate the estimation $\hat{t}_P$, we conducted experiments similar to those in \Cref{Protocol Suite Processing Time}, with $t_A$ adjusted to a fixed amount of time using Contiki random number generator call.
