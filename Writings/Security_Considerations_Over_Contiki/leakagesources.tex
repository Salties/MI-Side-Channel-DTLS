...
In this report, we experiment with the applications we described in \Cref{Sec: Applications}. For generality, we focus on information leakages with regard to the following subjects:
