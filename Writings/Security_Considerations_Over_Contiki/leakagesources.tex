...
When noncoresec is enabled, the 802.15.4 MAC Header is the only visible part in all Data Frames. In conclusion, we have not identify any suspicious leakage source in the MAC Header that links to the application data. The details of the analysis of 802.15.4 MAC Header is given in \Cref{Detail noncoresec Header}. 
...
DTLS is built over UDP; therefore visible headers are 802.15.4 MAC header, compressed IPv6 Header, UDP header and DTLS header.

\Cref{Detail DTLS Header}
%CONTINUE FROM HERE!!!!!!
