...
\Cref{Fig: An Example of Captured Traffic} is a screenshot of packets in an experiment analysed by Wireshark\cite{Wireshark}. As we can see in \Cref{Fig: An Example of Captured Traffic}, the following side channel information are available in the captured traffic:

\begin{itemize}
	\item Unencrypted headers of packets. 
	\item Timing of packets.
	\item Length of packets.
\end{itemize}
...
In this research, we assume the value of ciphertext is independent to the plaintext and key. 
