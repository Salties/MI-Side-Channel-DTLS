...
Therefore for observables in lower layer headers those are independent to any upper layer attributes, we suspect there is no information leakage based on \Cref{Te: IR}.
